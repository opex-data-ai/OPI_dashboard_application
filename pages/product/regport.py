...
async def show_regport_product_page():
    async def content():
        ...
        async def feature_adoption_content():
            ...
            async def load_data():
                ...
                container.clear()
                with container:
                    ui.label('Feature Adoption Analysis').classes('text-2xl font-bold text-slate-900 mb-4')
                    ui.label('Detailed feature adoption metrics and user behavior analytics').classes('text-slate-600')
        ...
        async def organization_deep_dive_content():
            ...
            with container:
                ...
                ui.label('The development is in progress. The tab provides a deeper dive into organizations activities.').classes(ThemeManager.TYPOGRAPHY['body'])
        ...
        await create_page_template(
            page_title='RegPort Performance Dashboard',
    ...
    await dashboard_layout(content, page_title="RegPort Performance Dashboard", active_page="product/regport")